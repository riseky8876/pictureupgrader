...
// FIX: Reduced from 1200 to 20 — original value caused massive stack allocation
// (1200 x Object_t + 1200 x CodeFormerResult_t with cv::Mat/vector members = stack overflow)
#define MAX_DET_FACE_COUNT 20
...
// FIX: PipeResult_t now heap-allocated via unique_ptr in pipeline.cpp
// Never allocate PipeResult_t on the stack — always use heap (new/unique_ptr)
